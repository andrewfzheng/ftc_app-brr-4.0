...
public class GoldAlignDetector extends DogeCVDetector {
    ...
    public Mat process(Mat input) {
        ...
        if(bestRect != null){
            ...
            // Draw center point
            //Imgproc.circle(displayMat, new Point( xPos, bestRect.x+ (bestRect.width / 2)), 5, new Scalar(0,255,0),2);
            ...
            // Draw Current X
            //Imgproc.putText(displayMat,"Current X: " + bestRect.y,new Point(10,getAdjustedSize().width - 10),0,0.5, new Scalar(255,255,255),1);
            found = true;
        }else{
            found = false;
            aligned = false;
